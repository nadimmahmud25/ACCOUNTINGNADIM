...
namespace ACCOUNTINGNADIM {
    ...
    public partial class DSStock : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountsRow AddAccountsRow(string Groups, string Ledgers, string Address, string Item, string Unit, double Balance, double M) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public double M {
                get {
                    try {
                        return ((double)(this[this.tableAccounts.MColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'M\' in table \'Accounts\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAccounts.MColumn] = value;
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsMNull() {
                return this.IsNull(this.tableAccounts.MColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetMNull() {
                this[this.tableAccounts.MColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ACCOUNTINGNADIM.DSStockTableAdapters {
    ...
    public partial class CompanyTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int Fill(DSStock.CompanyDataTable dataTable) {
        ...
        public virtual DSStock.CompanyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DSStock.CompanyDataTable dataTable = new DSStock.CompanyDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DSStock.CompanyDataTable dataTable) {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "select a.Groups,L.Ledgers,L.Address,a.Item,a.Unit,SUM(a.Credit)-SUM(a.Debit) as B" +
                "alance,SUM(a.WQty)-SUM(a.DQty) as M from Accounts a inner join Ledgers L on a.Le" +
                "dgers_ID=L.LNo group by a.Groups,L.Ledgers,L.Address,a.Item,a.Unit";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DSStock.AccountsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DSStock.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DSStock.AccountsDataTable dataTable = new DSStock.AccountsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
    }
