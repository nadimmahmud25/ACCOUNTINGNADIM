...
namespace ACCOUNTINGNADIM.STableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "select L.Groups,L.Ledgers,L.Address,a.Item,a.Unit,SUM(a.Credit)-SUM(a.Debit) as B" +
                "alance,SUM(a.WQty)-SUM(a.DQty) as M from Accounts a inner join Ledgers L on a.Gr" +
                "oups=L.Groups group by L.Groups,L.Ledgers,L.Address,a.Item,a.Unit";
        ...
        public virtual int Fill(S.AccountsDataTable dataTable) {
        ...
        public virtual S.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            S.AccountsDataTable dataTable = new S.AccountsDataTable();
